...
use rand::Rng;
use std::{ops::Range,ops::Neg, fs, f64::consts::PI};
...
fn main() -> Result<(), Box<dyn std::error::Error>>{
    ...
    let material_left   = Material::Lambertian { albedo: vec3::new(0., 0., 1.) };
    let material_right  = Material::Lambertian { albedo: vec3::new(1., 0., 0.) };
